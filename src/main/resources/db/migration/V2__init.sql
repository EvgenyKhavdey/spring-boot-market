...
INSERT INTO orders(customer_id, manager, price, payment, order_status, shipping_method, address, contact_email, creation_time, deliver_time, details)
VALUES (4, null, 44990,0, 0, 0, 'Москва, улицы Твекрсая 5', 'user1@user.ru',  '2022-02-18 17:33:34', '2022-02-21 09:22:00', 'До двери'),
       (4, 2, 32290,1, 3, 1, 'Москва, улицы Твекрсая 5', 'user1@user.ru',  '2021-12-01 12:01:52', '2021-12-19 12:00:00', 'До двери'),
       (4, 3, 32290,1, 2, 1, 'Москва, улицы Твекрсая 5', 'user1@user.ru',  '2022-01-30 14:01:12', '2022-02-21 09:22:00', 'До двери'),
       (5, null, 44990,0, 0, 0, 'Москва, улицы Охотный ряд 1', 'user2@user.ru',  '2022-02-18 17:33:34', '2022-02-21 09:22:00', 'До двери'),
       (5, 2, 32290,1, 3, 1, 'Москва, улицы Охотный ряд 1', 'user2@user.ru',  '2021-12-01 12:01:52', '2021-12-19 12:00:00', 'До двери'),
       (5, 3, 32290,1, 2, 1, 'Москва, улицы Охотный ряд 1', 'user2@user.ru',  '2022-01-30 14:01:12', '2022-02-21 09:22:00', 'До двери'),
       (6, null, 44990,0, 0, 0, 'Москва, Красная площадь 1', 'user3@user.ru',  '2022-02-18 17:33:34', '2022-02-21 09:22:00', 'До двери'),
       (6, 2, 32290,1, 3, 1, 'Москва, Красная площадь 1', 'user3@user.ru',  '2021-12-01 12:01:52', '2021-12-19 12:00:00', 'До двери'),
       (6, 3, 32290,1, 2, 1, 'Москва, Красная площадь 1', 'user3@user.ru',  '2022-01-30 14:01:12', '2022-02-21 09:22:00', 'До двери');
